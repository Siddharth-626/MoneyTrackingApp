    ...
    <AuthGate>
      <main className="mx-auto max-w-6xl p-4 md:p-8">
        ...
        {error ? (
          ...
          <div className="rounded-xl bg-white dark:bg-slate-800 p-8 text-center shadow-panel">
            <p className="text-slate-600 dark:text-slate-400">No financial profile found. Please ensure your account is set up correctly.</p>
          </div>
        ) : (
