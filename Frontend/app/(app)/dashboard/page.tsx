    ...
    <AuthGate>
      <main className="mx-auto max-w-6xl p-4 md:p-8">
        ...
        {error ? (
          ...
          <p className="text-slate-600 dark:text-slate-400 animate-pulse">Loading financial data...</p>
        ) : !data ? (
          <p className="text-slate-600 dark:text-slate-400">Profile data not found.</p>
        ) : (
