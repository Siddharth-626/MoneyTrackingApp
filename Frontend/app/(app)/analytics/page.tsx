      ...
      <main className="mx-auto max-w-6xl p-4 md:p-8">
        ...
        {error ? (
          <div className="mb-6 rounded-2xl bg-red-50 dark:bg-red-900/20 p-6 border border-red-100 dark:border-red-900/30">
            <h2 className="text-lg font-semibold text-red-800 dark:text-red-300">Error Loading Analytics</h2>
          ...
          <div className="rounded-2xl bg-white dark:bg-slate-800 p-8 text-center shadow-panel">
            <p className="text-slate-600 dark:text-slate-400">Unable to load analytics profile. Please check your data.</p>
          </div>
        ) : (
