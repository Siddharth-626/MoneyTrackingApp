      ...
      <main className="mx-auto max-w-6xl p-4 md:p-8">
        ...
        {error ? (
          ...
          <div className="flex flex-col items-center justify-center py-12">
            <svg className="h-8 w-8 animate-spin text-bankBlue dark:text-slate-400" viewBox="0 0 24 24" fill="none">
          ...
          <div className="rounded-xl bg-white dark:bg-slate-800 p-8 text-center shadow-panel">
            <p className="text-slate-600 dark:text-slate-400">No financial profile found. Data is required to display analytics.</p>
          </div>
        ) : (
