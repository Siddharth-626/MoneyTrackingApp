  ...
  if (loading || !user) {
    return (
      <div className="flex min-h-screen flex-col items-center justify-center gap-4 p-6">
        ...
        {isSlow && (
          <div className="mx-auto mt-4 w-full max-w-xs rounded-xl bg-amber-50 dark:bg-amber-900/30 border border-amber-200 dark:border-amber-800 p-3 text-sm text-amber-700 dark:text-amber-400 text-center">
            Authentication is taking longer than usual. Please check your connection.
          </div>
        )}
      </div>
    );
